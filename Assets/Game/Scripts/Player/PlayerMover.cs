    ...
    private void FixedUpdate()
    {
        if (IsEnabled)
        {
            ...
            if (Input.GetKey(KeyCode.Space) && OnFloor)
            {
                ...
                _rb.AddForce(-targetF * localSpeed/5f, ForceMode.Impulse);
                stepped = false;
            }
            ...
            {
                _stamina -= Time.deltaTime * localSpeed*1.5f;
                if( _stamina > 0)
                {
            ...
            _staminaImg.fillAmount = _stamina / _maxStamina;
        ...
        if (stepped)
        {
            ...
            _stamina += Time.deltaTime * _speed/4f;
        }
        else
        {
            _timer = 0;
            ...
            {
                _stamina += Time.deltaTime * _speed;
            }
            else
            {
                _stamina = _maxStamina;
